...
for priv in keys:
	try:
		...
		eth_balance = requests.get("https://api.etherscan.io/api?module=account&action=balance&address=0x" + eth_addr_hex + "&tag=latest" + "&apikey=JH9SMTEWZDBCVCWH47XR6K9RBNNRHSBGZC").json()["result"]
